...
function output(number){
     var cont = ["Home", "Products", "Testimonials", "Rates", "Contact", "Golden Isles Web Services"]
     if (number == 1) {
        document.getElementById('title').innerHTML = cont[0];
        ...
        document.getElementById('title').innerHTML = cont[1];
        ...
        document.getElementById('title').innerHTML = cont[2];
        ...
        document.getElementById('title').innerHTML = cont[3];
        ...
        document.getElementById('title').innerHTML = cont[4];
        ...
        document.getElementById('title').innerHTML = cont[5];
